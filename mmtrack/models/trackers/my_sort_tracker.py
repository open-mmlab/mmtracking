...
class MySORTTracker(BaseTracker):
    ...
    def track(self,
        ...
        if self.empty or bboxes.size(0) == 0:
            ...
            if len(active_ids) > 0:
                ...
                # print()
                # print("..............")
                # print(track_bboxes.shape, track_bboxes[0])
                # expanse_bboxes = self.expanse_bboxes(track_bboxes)
                # print(expanse_bboxes.shape, expanse_bboxes[0])
                # print("----------------")
    ...
    def expanse_bboxes(self, bboxes, b: float = 0.3):
        w = bboxes[:, 2] - bboxes[:, 0]
        h = bboxes[:, 3] - bboxes[:, 1]
