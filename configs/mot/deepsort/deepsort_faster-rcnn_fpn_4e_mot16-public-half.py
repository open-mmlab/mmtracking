...
model = dict(
    pretrains=dict(
        ...
        '/mnt/lustre/share_data/shensanjing/model/sort/publish_model/faster-rcnn_r50_fpn_4e_mot16-half-4c1b09ac.pth',
        reid=  # noqa: E251
        # 'https://download.openmmlab.com/mmtracking/mot/reid/tracktor_reid_r50_69e_mot16-a2e459b3.pth'  # noqa: E501
        '/mnt/lustre/share_data/shensanjing/model/sort/publish_model/tracktor_reid_r50_69e_mot16-a2e459b3.pth'
    ))
