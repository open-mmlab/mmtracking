    ...
    train_cfg=dict(  # Config of training hyperparameters for rpn and rcnn
        rpn=dict(  # Training config of rpn
            ...
            sampler=dict(  # Config of positive/negative sampler
                ...
                num=64,  # Number of samples when the examplar image and seach image are positive pair.
                pos_fraction=0.25,  # The ratio of positive samples in the total samples when the examplar image and seach image are positive pair.
                add_gt_as_proposals=False),  # Whether add GT as proposals after sampling.
            num_neg=16,  # Number of negative samples when the examplar image and seach image are negative pair.
