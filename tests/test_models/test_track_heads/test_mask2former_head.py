...
class TestMask2FormerHead(TestCase):
    ...
    def test_mask2former_head_loss(self):
        ...
        mask2former_head = Mask2FormerHead(**config)
    ...
    def test_mask2former_head_predict(self):
        ...
        mask_cls_results, mask_pred_results = mask2former_head.predict(
            feats, [data_sample])

        assert mask_cls_results.shape == (100, 41)
        assert mask_pred_results.shape == (100, 2, s, s)
